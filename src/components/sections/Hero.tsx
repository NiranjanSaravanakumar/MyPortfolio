        ...
        >
            ...
            >
                <div
                    ...
                    style={{ gap: 80, minHeight: "calc(92vh - 80px)" }}
                >
                        ...
                        >
                            ...
                            <span
                                ...
                                style={{
                                    ...
                                    lineHeight: 0.95,
                                    textShadow: "0 0 80px rgba(0,255,102,0.18)",
                                }}
                            >
                                NIRANJAN
                            </span>
                        ...
                        >
                            ...
                            <a
                                ...
                                style={{
                                    ...
                                    fontWeight: 700,
                                    borderRadius: 16,
                                    boxShadow: "0 0 28px rgba(0,255,102,0.28), 0 4px 20px rgba(0,0,0,0.4)",
                                    transition: "box-shadow 0.22s ease, transform 0.22s ease",
                                    textDecoration: "none",
                                }}
                                onMouseEnter={(e) => {
                                    const el = e.currentTarget as HTMLAnchorElement;
                                    el.style.boxShadow = "0 0 44px rgba(0,255,102,0.50), 0 8px 28px rgba(0,0,0,0.45)";
                                    el.style.transform = "scale(1.02)";
                                }}
                                onMouseLeave={(e) => {
                                    const el = e.currentTarget as HTMLAnchorElement;
                                    el.style.boxShadow = "0 0 28px rgba(0,255,102,0.28), 0 4px 20px rgba(0,0,0,0.4)";
                            ...
                            <a
                                ...
                                style={{
                                    ...
                                    fontWeight: 700,
                                    borderRadius: 16,
                                    border: "1.5px solid rgba(0,255,102,0.30)",
                                    transition: "all 0.22s ease",
                                    textDecoration: "none",
                                }}
                                onMouseEnter={(e) => {
                                    const el = e.currentTarget as HTMLAnchorElement;
                                    el.style.background = "rgba(0,255,102,0.10)";
                                    el.style.borderColor = "rgba(0,255,102,0.55)";
                                    el.style.boxShadow = "0 0 24px rgba(0,255,102,0.18)";
                                    el.style.transform = "scale(1.02)";
                                }}
                                onMouseLeave={(e) => {
                                    const el = e.currentTarget as HTMLAnchorElement;
                                    el.style.background = "rgba(0,255,102,0.06)";
                                    el.style.borderColor = "rgba(0,255,102,0.30)";
                                ...
                                {stats.map(({ value, label }) => (
                                    <div
                                        ...
                                        onMouseEnter={(e) => {
                                            ...
                                            el.style.boxShadow     = "0 0 20px rgba(0,255,102,0.10)";
                                        }}
                                        onMouseLeave={(e) => {
                                            const el = e.currentTarget as HTMLDivElement;
                                            el.style.background    = "rgba(0,255,102,0.04)";
                                ...
                                {socialLinks.map(({ href, icon: Icon, label }) => (
                                    <a
                                        ...
                                        onMouseEnter={(e) => {
                                            ...
                                            el.style.borderColor = "rgba(0,255,102,0.55)";
                                            el.style.background  = "rgba(0,255,102,0.08)";
                                            el.style.boxShadow   = "0 0 16px rgba(0,255,102,0.18)";
                                        }}
                                        onMouseLeave={(e) => {
                                            const el = e.currentTarget as HTMLAnchorElement;
